...
export const PieChart2 = ({ width = 450, height = 450, margin = 40 }) => {
  ...
  useEffect(() => {
    ...
    // set the color scale
    var color = scaleOrdinal().domain(subgroups).range(schemeSet1);
    ...
    svgLeg
      ...
      .append('circle')
      .attr('cx', 40)
      .attr('cy', (d, i) => 25 + i * 25) // 25 is where the first dot appears. 25 is the distance between dots
      .attr('r', 7)
      .style('fill', color);
    ...
    svgLeg
      ...
      .append('text')
      .attr('x', 60)
      .attr('y', (d, i) => 25 + i * 25) // 25 is where the first dot appears. 25 is the distance between dots
      .style('fill', color)
      .text((d) => d)
